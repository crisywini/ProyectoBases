...
public class InitDatabase {
	...
	public static void createAllTables() {
		...
		String createServiceInvoice = "CREATE TABLE Invoice_service ( code int NOT NULL AUTO_INCREMENT, address VARCHAR(20) NOT NULL, date VARVHAR(20) NOT NULL, description VARCHAR(40), total_payment VARCHAR(20) NOT NULL, PRIMARY KEY (code), FOREIGN KEY(code_service) REFERENCES Service (code) )"; // cantidad,devuelta??_pago_varchar_double?
		...
		String createProductTable = "CREATE TABLE ( code int NOT NULL AUTO_INCREMENT, name VARCHAR(20) NOT NULL, cantidad int NOT NULL, detalles VARCHAR(40), PRIMARY KEY(code), FOREIGN KEY(code_provier) REFERENCES Provider (code) )";
		String createInventoryTable = "CREATE ( code int NOT NULL AUTO_INCREMENT, date VARCHAR(20) NOT NULL, PRIMARY KEY(code) )";
		String createContractTable = "CREATE TABLE ( code int NOT NULL AUTO_INCREMENT, salary DOUBLE NOT NULL, start_date VARCHAR(20) NOT NULL, end_date VARCHAR(20) NOT NULL, PRIMARY KEY (code), FOREIGN KEY(code_employee) REFERENCES Employee (code) )"; // salario_double?
